...
export const REPORTS: Record<ReportKind, ReportDefinition> = {
    ...
    payouts: {
        dimensions: ["payout"],
        columns: [
            "operation_type", "operation_date", "booking_id", "customer", "transfer_id", "refund_id",
            "artist_id", "artist_name", "status", "payout_date", "refund_date",
            "amount_ht_cents", "vat_amount_cents", "amount_ttc_cents", "refunded_amount_cents",
            "currency", "invoice_number", "invoice_id", "pennylane_delivery_status", "stripe_reference",
        ],
        defaultColumns: [
            "operation_type", "operation_date", "booking_id", "customer", "artist_name", "status",
            "amount_ht_cents", "vat_amount_cents", "amount_ttc_cents", "refunded_amount_cents",
            "stripe_reference",
        ],
    },
