...
const DICTIONARY: Record<Locale, Record<string, string>> = {
  en: {
    ...
    payouts: "Payouts, refunds & invoices", payoutsDescription: "Artist transfers, customer refunds and self-billing invoice reconciliation.",
    ...
    account: "My profile", accountSettings: "Account settings", close: "Close", currentEmail: "Current email", newEmail: "New email", emailCode: "Verification code",
    changeEmail: "Change email", sendCode: "Send code", verifyCode: "Verify code", confirmEmail: "Confirm new email", emailCodeSent: "A verification code has been sent.", emailUpdated: "Email updated.",
    passwordSecurity: "Password", currentPassword: "Current password", newPassword: "New password", confirmPassword: "Confirm new password", changePassword: "Change password", passwordUpdated: "Password updated.", passwordsDoNotMatch: "New passwords do not match.", passwordMinimum: "Use at least 6 characters.",
    service: "Service date", payment: "Payment date", refund: "Refund date", payout: "Operation date", invoice: "Invoice issue date",
    payoutOperation: "Payout", refundOperation: "Refund",
  ...
  fr: {
    ...
    payouts: "Versements, remboursements et factures", payoutsDescription: "Virements aux artistes, remboursements clients et rapprochement des factures d’auto-facturation.",
    ...
    account: "Mon profil", accountSettings: "Paramètres du compte", close: "Fermer", currentEmail: "E-mail actuel", newEmail: "Nouvel e-mail", emailCode: "Code de vérification",
    changeEmail: "Modifier l’e-mail", sendCode: "Envoyer le code", verifyCode: "Vérifier le code", confirmEmail: "Confirmer le nouvel e-mail", emailCodeSent: "Un code de vérification a été envoyé.", emailUpdated: "E-mail mis à jour.",
    passwordSecurity: "Mot de passe", currentPassword: "Mot de passe actuel", newPassword: "Nouveau mot de passe", confirmPassword: "Confirmer le nouveau mot de passe", changePassword: "Modifier le mot de passe", passwordUpdated: "Mot de passe mis à jour.", passwordsDoNotMatch: "Les nouveaux mots de passe ne correspondent pas.", passwordMinimum: "Utilisez au moins 6 caractères.",
    service: "Date de prestation", payment: "Date de paiement", refund: "Date de remboursement", payout: "Date d’opération", invoice: "Date d’émission de facture",
    payoutOperation: "Versement", refundOperation: "Remboursement",
...
const COLUMN_LABELS: Record<ReportColumn, readonly [string, string]> = {
  ...
  operation_type: ["Operation type", "Type d’opération"], operation_date: ["Operation date", "Date d’opération"], refund_id: ["Stripe refund ID", "ID de remboursement Stripe"],
